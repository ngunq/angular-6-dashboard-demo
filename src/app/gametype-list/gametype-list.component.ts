...
@Component({
  selector: 'app-gametype-list',
  templateUrl: './gametype-list.component.html',
  styleUrls: ['./gametype-list.component.css']
})
export class GametypeListComponent implements OnInit {

  constructor(public topGameService: TopGameChartService, private config: AppConfig, private timeService: TimeSelectService, private areaFilter: AreaFilterService, private categoryFilter: CategoryFilterService, private deptFilter: DeptFilterService, public gametypeFilter: GametypeFilterService, private revbyMonthService: RevByMonthChartService, private productFilterService: ProductFilterService, private puService: PuChartService, private arppuService: ArppuChartService) { }
